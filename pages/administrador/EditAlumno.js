...
import AddForm from "components/Alumnos/Forms/AddForm";
import EditForm from "components/Alumnos/Forms/EditForm";


export default function EditAlumno({setView, selectedUser}) {
                ...
                <div className="w-full mb-12 px-4">
                    ...
                    >
                        ...
                        <div className="block w-full mb-4 overflow-x-auto">
                            ...
                            <EditForm selectedUser={selectedUser} setView={setView}></EditForm>
                        </div>
                    </div>
                </div>
            </div>
