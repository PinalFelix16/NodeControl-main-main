...
const AlumnoTabs = ({ selectedUser, alumnoData }) => {
  ...
  const addClaseAlumno = async (id) => {
    // MOD: tomar las clases del programa seleccionado y prepararlas para asignar al alumno
    ...
    const data = {
      alumno_id: selectedUser,   // para updateClase
      id_alumno: selectedUser,   // se mantiene por si algún flujo lo usa
      id_programa: id,
      claseIds,                  // ← lista de clases a asignar
    };
