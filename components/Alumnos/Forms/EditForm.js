...
import {fetchAlumnoAllData, storeAlumno, updateAlumno} from "services/api/alumnos"
...
export default function EditForm({setView, selectedUser}) {
    ...
    const handleSubmit = async (e) => {
        ...
        const response = await updateAlumno(formData, selectedUser);
                            ...
                            <div className="relative flex flex-col min-w-0 break-words w-full mb-6 shadow-lg rounded-lg bg-blueGray-200 border-0">
                                <div className="rounded-t mb-0 px-6 py-6">
                                    <div className="text-center mb-3">
                                        <i className="fas fa-user-edit text-6xl "></i>
