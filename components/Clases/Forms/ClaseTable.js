...
export default function ClaseTable({ color, maestros, status, setStatus, setView, setSelectedUser, handleDelete, searchText, setSearchText }) {
  return (
    <>
      <div
        className={
          ...
          <div className="flex flex-wrap items-center">
            <div className="relative w-full px-4 max-w-full flex-grow flex-1">
              ...
              <span className="mt-4 items-stretch">
               ...
               {/* SE OCUPARA PARA LA NUEVA VENTANA DE CLASES*/}
...
ClaseTable.defaultProps = {
  color: "light",
};

ClaseTable.propTypes = {
