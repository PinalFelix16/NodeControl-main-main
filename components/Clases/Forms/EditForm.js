...
import {fetchMaestroAllData, updateMaestro} from "services/api/maestros"

export default function EditForm({setView, selectedUser}) {
    ...
    async function getMaestro() {
        const data = await fetchMaestroAllData(selectedUser);
        setMaestroData(data)
      }
    ...
    const handleSubmit = async (e) => {
        ...
        const response = await updateMaestro(formData, selectedUser);
        console.log(formData, selectedUser);
